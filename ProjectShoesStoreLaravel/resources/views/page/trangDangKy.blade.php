			...
			<div class="wrap-login100 p-t-85 p-b-20">
				@if ( Session::has('saipass') )
        			<div class="alert alert-danger alert-dismissible" role="alert">
            			<strong>{{ Session::get('saipass') }}</strong>
				...
				@endif
				   ...
				   @if ( Session::has('trungtaikhoang') )
        			<div class="alert alert-danger alert-dismissible" role="alert">
            			<strong>{{ Session::get('trungtaikhoang') }}</strong>
            			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                			<span aria-hidden="true">&times;</span>
                			<span class="sr-only">Close</span>
            			</button>
   				...
   				@endif
				<form class="login100-form validate-form" action="thucHienDangKy" method="POST">
                        {{ csrf_field() }}
                    ...
                    <div class="wrap-input100 validate-input m-b-50" data-validate="Enter repeat passWord">
					...
					<div class="container-login100-form-btn">
						<input class="login100-form-btn" name="Login" type="submit" value="Registration"/>
                    </div>
					...
					<ul class="login-more p-t-190">
						...
						<li>
							...
							<a href="trangDangNhap" class="txt2">
								Sign in
							</a>
						</li>
					</ul>
